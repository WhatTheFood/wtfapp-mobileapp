wtf.factory('loginservice', ['$http', '$q', '$localStorage', '$sessionStorage',
    function ($http, $q, $localStorage, $sessionStorage) {
        ...
        serverAPI = "https://wtf.weit.fr/api"; // prod
        ...
        var factory = {
            ...
            loginfb: function () {
                ...
                openFB.login(
                    function (response) {
                        return facebookLoginHandler(response);
                    },
